    ...
    <div className={styles.content}>
      <div className={styles.columns}>
        <div className={styles.contact}>
          <nav className={styles.links} aria-label="Footer"><Link href="/work"><BevelText text="work" /></Link><Link href="/studio"><BevelText text="studio" /></Link><Link href="/contact"><BevelText text="contact" /></Link></nav>
      ...
      <Link href="/" className={`${styles.wordmark} font-serif`} aria-label="Burgama home"><BevelText text="burgama" /></Link>
